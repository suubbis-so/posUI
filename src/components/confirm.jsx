...
function Cornfirm(props) {
    return (
        <div className='bg-primary-manage  w-full h-5/6 absolute top-40 left-0 z-20 backdrop-blur-sm ' style={{display:props.confirm?'block':'none'}}>   
            <div className='py-6  bg-primary-white rounded-lg mx-4 sm:w-4/5 md:w-3/5 md:mx-20 lg:w-2/4 lg:mx-96 mt-3'>
                ...
                <div className='my-6 px-2 md:mx-6 lg:mx-18' style={{height:'45vh',overflowY:'scroll'}}  >
                    <table className='table-auto border relative bg-primary-greyishWhite relative ' >
                        <thead className='rounded-lg' style={{borderRadius:'1rem'}}>
                            <tr className='uppercase bt-4b'>
                                <th className='self-center font-normal py-2 px-2 md:px-4 sticky top-0 bg-primary-greyishWhite z-10 text-sm ' style={{borderRadius:'.4rem 0 0 0'}}>sno</th>
                                <th className='self-center font-normal py-2 px-2 md:px-4 sticky top-0 bg-primary-greyishWhite z-10 text-sm'>ritc no</th>
                                <th className='hidden lg:table-cell self-center font-normal py-2 md:px-4 sticky top-0 bg-primary-greyishWhite z-10 text-sm'>item name</th>
                                <th className='self-center font-normal py-2 px-2 md:px-4 sticky top-0 bg-primary-greyishWhite z-10 text-sm'>stock</th>
                                <th className='self-center font-normal py-2 px-2 md:px-4 sticky top-0 bg-primary-greyishWhite z-10 text-sm'>quantity</th>
                                <th className='hidden lg:table-cell self-center font-normal py-2 md:px-4 sticky top-0 bg-primary-greyishWhite z-10 text-sm'>unit price</th>
                                <th className='hidden lg:table-cell self-center font-normal py-2 md:px-4 sticky top-0 bg-primary-greyishWhite z-10 text-sm'>disc</th>
                                <th className='hidden lg:table-cell self-center font-normal py-2 md:px-4 sticky top-0 bg-primary-greyishWhite z-10 text-sm'>tax</th>
                                <th className='self-center font-normal py-2 px-2 md:px-4 sticky top-0 bg-primary-greyishWhite z-10 text-sm'>amount</th>
                            </tr>
                        </thead>
                            ...
                            {tableData.map((data)=>{
                                return(
                                    <tr className=' border-t-2 border-primary-gray' key={data.id}>
                                        <td className='text-sm py-2 px-2 lg:px-4 font-bold'>{data.sno}</td>
                                        <td className='text-sm py-2 px-2 lg:px-4'>{data.ritcNo}</td>
                                        <td className='hidden lg:table-cell text-sm py-2 px-2 lg:px-4'>{data.itemName}...</td>
                                        <td className='text-sm py-2 px-2 lg:px-4'>{data.stock}</td>
                                        <div className='flex text-center px-4'>
                                            <td className='text-sm self-top py-2 px-2'>{data.quantity}</td>
                                        </div>
                                        <td className='hidden lg:table-cell text-sm py-2 px-4'>%{data.disc}</td>
                                        <td className='hidden lg:table-cell text-sm py-2 px-4'>%{data.tax}</td>
                                        <td className='text-sm py-2 px-4  font-bold'>{data.amount}</td>
                                        <td className='hidden lg:table-cell text-sm py-2 px-4 text-center'>{data.unitPrice}</td>
                                </tr>
                                )
                            })}
            ...
            <div className='grid grid-cols-2 md:grid-cols-3 md:mx-6 lg:grid-cols-5 gap-2 mx-4 lg:mx-28'>
